                        ...
                        <div class="d-flex">
                            <div class="w-50 mr-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" name="organization" placeholder="주최자" value="{{ $information->organization }}">
                                    <small class="form-text text-muted">
                                        선택 항목입니다.
                                    </small>
                                    @error('organization')
                            ...
                            <div class="w-50 ml-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="date" name="start_date" placeholder="시작날짜" value="{{ $information->start_date->format('Y-m-d') }}">
                                    <small class="form-text text-muted">
                                        필수 입력 항목입니다.
                                    </small>
                                    @error('start_date')
                                    ...
                                    @enderror
                                    ~
                                    <input class="form-control" type="date" name="end_date" placeholder="종료날짜" value="{{ $information->end_date->format('Y-m-d') }}">
                                    <small class="form-text text-muted">
                                        필수 입력 항목입니다.
                                    </small>
                                    @error('end_date')
