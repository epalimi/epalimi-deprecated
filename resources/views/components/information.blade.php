...
<div id="{{ $information->id }}" class="card rounded-top border-bottom h-100">
    <img class="card-img-top" src="{{ $information->thumb != null ? url('storage/'.$information->thumb) : asset('svg/placeholder3x2.svg') }}">
    <div class="card-body d-flex flex-column mt-auto" style="flex: none;">
        <div class="duration p-3 text-white font-weight-bold mt-auto" style="background-color: rgb(38, 73, 145);">
        ...
        <div class="p-3">
            ...
            <h4 class="font-weight-bold mb-0" style="font-size: 1.1rem; height:2.8rem; overflow:hidden;">{{ $information->title }}</h4>
        </div>
        <hr class="m-0">
